...
| 21 | **JOLT** | 🟥 rust | procedural breakbeat — slices real breaks and rearranges them, eight levels from straight to ruptured, optionally walking between them on a cycle count |
